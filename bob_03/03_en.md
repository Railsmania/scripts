...
Second, the request.env is another special hash privided to us by Rails. It contains a lot of information about the current request environment. Omniauth has placed a special payload of information there about the user that just authenticated via our Open Authentication provider -- Digital Ocean.
